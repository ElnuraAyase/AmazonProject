...
//        String movieN = input.nextLine().trim();// remove extra spaces befor eand after
        ...
        int ticketsNum = getValidNumber(input, "number of tickets");                          // 1change

        double price = getValidPrice(input);

        double  totalPr;                                                                          //2nd change
        ...
        System.out.println("Total price for all tickets: " + totalPr);                            //2nd change
